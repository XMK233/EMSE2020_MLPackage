...
to match the model training input. For `EfficientNet-Lite4`, `height` x
`width` = 380 x 380 pixels. The input `images` are expected to have color values
in the range [0,1], following the
